...
Your team gets to choose the project you will work on (subject to some restrictions). 
...
- A design document. The design document has to show the following:
	...
	- Structural and runtime design views.
...
### Deadline
This will occur in the last week of class, by appointment. I anticipate people will prefer later in the week, so plan to have your code finished and working by Tuesday, Nov 28, at midnight (for demo Wed or Thursday). Demo slots will be assigned randomly.
